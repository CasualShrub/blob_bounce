...
public class Mackerel extends OrdinaryFish{
    ...
    public Mackerel(float spawnTime,boolean goRight, Consumer<Creature> movementFunction) {
        creatureId = 4;
        xVelocity = goRight ? 700 : -700;
        yVelocity = 0;
        width = 130;
        height = 130;
        movementSpeed = 0;

        this.xPosition = goRight ? leftStartX : rightStartX;
